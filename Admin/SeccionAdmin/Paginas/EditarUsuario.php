<?php 
    ...
    if  (isset($_GET['Id_Usuario'])) {
      ...
      if (isset($_POST['Enviar'])) { 
        ...
        $Sentencia = $conexion->prepare('update usuarios set  Cedula = ?, Nombre_Usuario = ?, Nombre = ?, Apellido = ?, Correo = ?, Contraseña = ? where Id_Usuario = ?');
        $arrParams=array($Cedula,$NombreUsuario,$Nombre, $Apellido, $Correo, $Contraseña, $Id);
								...
								<div class="card-body">
									<form action="EditarUsuario.php?Id_Usuario=<?php echo $_GET['Id_Usuario']; ?>" method="post">
												<div class="row">
													<div class="col-md-6 col-lg-6">
														<div class="form-group">
															...
															<input type="number" class="form-control" name="Cedula"  value="<?php echo $datos['Cedula'];?>" >
														</div>
													</div>
													<div class="col-md-6 col-lg-6">
														<div class="form-group">
															<label for="email2">Nickname</label>
															<input type="text" class="form-control" name="Nombre_Usuario" value="<?php echo $datos['Nombre_Usuario'];?>">
														</div>
													</div>			
												</div>
												<div class="row">
												...
												<div class="row">
													...
													<div class="col-md-6 col-lg-6">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="Contraseña" value="<?php echo $datos['Contraseña'];?>">
										...
										<div class="card-action">
											<button name="Enviar" class="btn btn-success">Modificar usuario</button>
