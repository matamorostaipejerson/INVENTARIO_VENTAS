<?php 
	...
	if (isset($_GET['FechaInicio']) && isset($_GET['FechaFinal'])  ) { 
		...
		$Sentencia = $conexion->prepare("SELECT * from salidas WHERE Fecha BETWEEN '$fechaInicio' and '$fechaFinal' and Estado=1 and Procesado=0" );
		$Sentencia ->execute(); 
				...
				<div class="panel-header bg-info">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">REPORTE DE INGRESOS POR DIA</h2>
				...
				<div class="page-inner mt--5">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Consultar Ingresos</div>
								</div>
								<div class="card-body">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Tabla de Ingresos de: <span
								...
								<div class="card-body">
									...
									<div class="row">
											...
											<div class="col-md-2 col-lg-2">
												<div class="form-group ">
												<label for="Total de Ingresos">Total de Ingresos:</label>
