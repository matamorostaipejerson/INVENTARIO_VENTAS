<?php 
	...
	if (isset($_POST['Registrar'])) { 
		...
		$Sentencia = $conexion->prepare('insert into proveedor(RazonSocial,PersonaContacto,Direccion,Telefono) values (?, ?, ?, ?);');
		$arrParams=array($RazonSocial , $PersonaContacto, $Direccion, $Telefono);
				...
				<div class="panel-header bg-dark2">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Añadir proveedor</h2>
								...
								<div class="card-body">
									<form action="" method="post">
												<div class="row">
													...
													<div class="col-md-6 col-lg-6">
														<div class="form-group">
															...
															<input type="number" class="form-control" name="PersonaContacto" >
														</div>
													</div>			
												</div>
												<div class="row">
										...
										<div class="card-action">
											<button name="Registrar" class="btn btn-success">Agregar Proveedor</button>
