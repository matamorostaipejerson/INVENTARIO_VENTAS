<?php 
	...
	if (isset($_POST['Registrar'])) { 
		...
		$Sentencia = $conexion->prepare('INSERT INTO articulos(Codigo,Id_Categoria ,Nombre,Cantidad,Marca,PrecioCosto,PrecioVenta,StockIdeal) VALUES (? ,? ,? ,? ,? ,?, ?, ?);');
		$arrParams=array( $Codigo,$Categoria,$Nombre, $Cantidad, $Marca , $PrecioCosto , $PrecioVenta , $StockIdeal);
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="TablaBasica" class="display table table-striped table-hover" >
											...
											<tbody>
											<?php
											    $Sentencia2 = $conexion->prepare('SELECT Id_Articulo,Codigo,articulos.Nombre,Cantidad,Marca,PrecioCosto,PrecioVenta,StockIdeal,categorias.Nombre AS categoria,Estado FROM articulos
