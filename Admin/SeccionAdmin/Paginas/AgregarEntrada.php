<?php 
	...
	if (isset($_SESSION['Id_Usuario'])) {
		...
		$Sentencia = $conexion->prepare('SELECT Id_Entrada FROM entradas ORDER by Id_Entrada DESC LIMIT 1');
		$Sentencia ->execute(); 
			...
			<div class="content">
				<div class="panel-header bg-info">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Registrar Entrada</h2>
				...
				<div class="page-inner mt--5">
					<div class="row">
									...
									<form action="" method="post" id="Form_Entrada">
										<div class="row">
											...
											<div class="col-md-5 col-lg-5">
												<div class="form-group">
													<label for="email2">Nombre Entrada</label>
												...
												<div class="form-group">
													...
													<div class="form-group form-group-default">
														<select class="form-control input-border-bottom"
															id="selectFloatingLabel" name="Prov" required>
															<option selected>Seleccionar</option>
															<?php 
																	$Sentencia = $conexion->prepare('SELECT Id_Proveedor,RazonSocial FROM proveedor');
																	$Sentencia ->execute(); 
																	$Proveedores =  $Sentencia ->fetchAll(PDO::FETCH_ASSOC);
                                                                    foreach ($Proveedores as $Proveedor) {?>
															<option value="<?php echo $Proveedor['Id_Proveedor'] ?>">
																<?php echo $Proveedor['RazonSocial'] ?></option>
															<?php } ?>
														</select>
													</div>
												</div>
						...
						<!-- Tabla de recibo entrada -->
						<div class="col-md-6">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Detalles de entrada</div>
								</div>
										...
										<thead class="thead-inverse">
											...
											<?php foreach ($Productos as $Producto ) {?>	
												<tr>
													...
													<td><?php echo $Producto['PrecioCosto'] ?></td>
