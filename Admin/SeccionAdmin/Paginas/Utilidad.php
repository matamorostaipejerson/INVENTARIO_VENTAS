<?php 
	...
	if (isset($_GET['FechaInicio']) && isset($_GET['FechaFinal'])) { 
		...
		if ($fechaInicio == "" && $fechaFinal =="" ) {
			...
			$validacion = true;
			$Sentencia = $conexion->prepare("SELECT salidas.Fecha,articulos.Codigo,articulos.Nombre,articulos.Marca,detalle_venta.Cantidad,articulos.PrecioCosto,PrecioXunidad,detalle_venta.Total FROM `detalle_venta` 
			...
			WHERE salidas.Fecha BETWEEN '$fechaInicio' AND '$fechaFinal'");
			$Sentencia ->execute(); 
			$Salidas =  $Sentencia ->fetchAll(PDO::FETCH_ASSOC);
		}
	}
	else{
		$validacion=false;
...
<body>
				...
				<div class="panel-header bg-info">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Utilidad</h2>
						...
						<div class="card">
							<div class="card-header">
								<div class="d-flex align-items-center">
									<h4 class="card-title">Tabla de Utilidad </h4>

								</div>
							</div>
							<div class="card-body">
								<div class="table-responsive">
									<table id="TblUtilidad" class="display table table-striped table-hover">
										<thead>
											<tr>
												<th>Fecha</th>
												<th>Codigo</th>
										...
										<tbody>
											...
											<tr>
												...
												<td><?php echo $Salida['PrecioCosto'] ?></td>
												<td><?php echo $Salida['PrecioXunidad'] ?></td>
												<td><?php echo $Salida['PrecioCosto']*$Salida['Cantidad'] ?></td>
	...
	<script type="text/javascript" src="../DataTables/datatables.min.js"></script>
	  ...
	  <script src="./../DatatablesBotones/Buttons-1.5.6/js/dataTables.buttons.min.js"></script>
    <script src="../DatatablesBotones/JSZip-2.5.0/jszip.min.js"></script>
    <script src="../DatatablesBotones/pdfmake-0.1.36/pdfmake.min.js"></script>
    <script src="../DatatablesBotones/pdfmake-0.1.36/vfs_fonts.js"></script>
    <script src="../DatatablesBotones/Buttons-1.5.6/js/buttons.html5.min.js"></script>
	<!-- SUM()  Datatables-->
