<?php 
    ...
    if  (isset($_GET['Id_Empresa'])) {
        $Id = $_GET['Id_Empresa'];
        $Sentencia = $conexion->prepare('select * from empresa where Id_Empresa = ?;');
        $Sentencia ->execute([$Id]); 
        $datos =  $Sentencia ->fetch(PDO::FETCH_ASSOC);
        if ($Sentencia-> rowCount() > 0) {
            $Nombre = $datos['Id_Empresa'];
      ...
      if (isset($_POST['Enviar'])) { 
		$Nombre = $_POST['Nombre'];
		$NIT= $_POST['NIT']; 
        $Sentencia = $conexion->prepare('update empresa set  Nombre = ?, NIT = ? where Id_Empresa = ?');
        $arrParams=array($Nombre,$NIT, $Id);
                    ...
                    <div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									<form action="EditarTienda.php?Id_Empresa=<?php echo $_GET['Id_Empresa']; ?>" method="post">
												<div class="row">
													<div class="col-md-6 col-lg-6">
														<div class="form-group">
															<label for="email2">Id Tienda</label>
															<input type="text" class="form-control" disabled  value="<?php echo $datos['Id_Empresa'];?>" >
														</div>
													</div>
													<div class="col-md-6 col-lg-6">
														<div class="form-group">
												...
												<div class="row">
													<div class="col-md-6 col-lg-12">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="NIT"  value="<?php echo $datos['NIT'];?>">
														</div>
													</div>			
												</div>
										</div>
