<?php 
	...
	if (isset($_POST['Registrar'])) { 
		...
		$Sentencia = $conexion->prepare('INSERT INTO categorias(Nombre,Descripcion) VALUES (? ,?);');
		$arrParams=array( $Nombre,$Descripcion);
				...
				<div class="panel-header bg-dark2">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Categorias</h2>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Registrar Categoria</div>
								</div>
								<div class="card-body">
									<form action="" method="post">
												...
												<div class="row">
													<div class="col-md-12 col-lg-12">
														<div class="form-group">
															<textarea name="Descripcion" class="form-group" rows="5" cols="40">Descripcion</textarea>
														</div>
													</div>	
												</div>
											</div>
                        ...
                        <div class="card">
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="TablaBasica" class="display table " >
											<thead>
												<tr>
													<th>Id</th>
													<th>Nombre</th>
											...
											<tbody>
											<?php
											    $Sentencia2 = $conexion->prepare('SELECT * FROM categorias');
												$Sentencia2 ->execute(); 
												$resultado1 = $Sentencia2-> fetchAll(PDO::FETCH_ASSOC);
												foreach ($resultado1 as $Array) {?>
												<tr>
													<td><?php echo $Array['IdCategoria'];?></td>
													...
													<td align="center">
														<div class="dropdown">
															...
															<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
																<a class="dropdown-item" href="EditarCategoria.php?IdCategoria=<?php echo $Array['IdCategoria']?>">Editar</a>
																<a class="dropdown-item" href="EliminarCategoria.php?IdCategoria=<?php echo $Array['IdCategoria']?>">Eliminar</a>
															</div>
														</div>
													</td>
												</tr>
