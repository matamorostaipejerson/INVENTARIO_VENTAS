<?php 
    ...
    if  (isset($_GET['IdCategoria'])) {
        $Id = $_GET['IdCategoria'];
        $Sentencia = $conexion->prepare('SELECT * from categorias where IdCategoria = ?;');
        $Sentencia ->execute([$Id]); 
      ...
      if (isset($_POST['Enviar'])) { 
        ...
        $Sentencia = $conexion->prepare('UPDATE categorias set  Nombre = ?,Descripcion = ? where IdCategoria = ?');
        $arrParams=array($Nombre,$Descripcion,$Id);
                    ...
                    <div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									<form action="EditarCategoria.php?IdCategoria=<?php echo $_GET['IdCategoria']; ?>" method="post">
												...
												<div class="row">
													<div class="col-md-12 col-lg-12">
														<div class="form-group">
															<textarea name="Descripcion" class="form-group" rows="5" cols="50"><?php echo $datos['Descripcion'];?></textarea>
														</div>
													</div>	
												</div>
										...
										<div class="card-action">
											<button name="Enviar" class="btn btn-success">Modificar Categoria</button>
