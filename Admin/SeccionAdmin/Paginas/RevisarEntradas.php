...
<body>
				...
				<div class="panel-header bg-dark2">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Compras</h2>
						...
						<div class="card">
							<div class="card-header">
								<div class="d-flex align-items-center">
									<h4 class="card-title">Tabla de Compra</h4>
									<a href="AgregarEntrada.php" class="btn btn-primary btn-round ml-auto">
							...
							<div class="card-body">
								<div class="table-responsive">
									<table id="TablaBasica" class="display table table-striped table-hover">
										<thead>
											<tr align="center">
												<th>Id Compra</th>
										...
										<tbody>
											<?php
											    $Sentencia2 = $conexion->prepare('SELECT * from entradas INNER JOIN proveedor ON entradas.Id_Proveedor = proveedor.Id_Proveedor');
												$Sentencia2 ->execute(); 
												$resultado1 = $Sentencia2-> fetchAll(PDO::FETCH_ASSOC);
												foreach ($resultado1 as $Array) {?>
											<tr align="center">
												<td><?php echo $Array['Id_Entrada'];?></td>
												<td><?php echo $Array['Nombre'];?></td>
												<td><?php echo $Array['RazonSocial'];?></td>
												<td><?php echo $Array['Fecha'];?></td>
												<td><?php echo $Array['ValorTotal'];?></td>
												<td><?php if ($Array['Estado'] == 1) {?>
													<i style=" color:#72F20E; padding-top:2px;" class="fas fa-check"></i>
													
												 <?php } else{ ?>
													<i class="fas fa-times" style=" color:#A10808; padding-top:2px;"></i>
												 <?php }
												?></td>
												<td align="center">
													<button class="btn btn-primary BtnDetalles"
														value="<?php echo $Array['Id_Entrada'];  ?>">Ver
														Detalles</button>
												</td>
									...
									<!-- Modal -->
									<div class="modal fade" id="Mdetalles" tabindex="-1" role="dialog"
										aria-labelledby="exampleModalLabel" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="exampleModalLabel">Detalles de Entrada <span id="Id_Entrada"></span> </h5>
												...
												<div class="modal-body">
													<table class="table table-striped table-inverse table-responsive" id="TblDetalles">
												...
												<div class="modal-footer">
													...
													<button type="button" class="btn btn-primary" id="ChangeState">Cambiar Estado</button>
												</div>
											</div>
										</div>
									</div>
	...
	<script src="./../Js/Datatable-Basico.js"></script>
</body>
