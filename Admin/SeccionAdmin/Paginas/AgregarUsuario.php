<?php 
	...
	if (isset($_POST['Registrar'])) { 
        ...
        $Estado = $_POST['Estado'];
        $Sentencia2 = $conexion->prepare('select * from usuarios where Cedula = ?;');
		$Sentencia2 ->execute([$Cedula]); 
		$datos2 =  $Sentencia2 ->fetch(PDO::FETCH_ASSOC);
        if ($Sentencia2->RowCount()==1) {
            echo '<script type="text/javascript">alert("El usuario ya existe en la base de datos");</script>';
        }else {
            $Sentencia = $conexion->prepare('insert into usuarios(Cedula,Nombre_Usuario,Nombre,Apellido,Correo,Contraseña,Estado) values (?, ?, ?, ?, ?, ?, ?);');
            $arrParams=array($Cedula, $Nombre_Usuario, $Nombre, $Apellido, $Correo, $Contraseña, $Estado);
												...
												<div class="row">
													<div class="col-md-6 col-lg-6">
														<div class="form-group">
															<label for="email2">Cedula</label>
															<input type="number" class="form-control" name="Cedula"   >
														</div>
													</div>
													<div class="col-md-6 col-lg-6">
														<div class="form-group">
															<label for="email2">Nombre_Usuario</label>
												...
												<div class="row">
													...
													<div class="col-md-6 col-lg-6">
														<div class="form-group">
                                                            ...
                                                            <input hidden type="text" name="Estado" class="form-control" value="1" >
														</div>
													</div>				
												</div>
										</div>
										<div class="card-action">
											<button name="Registrar" class="btn btn-success">Agregar Usuario</button>
