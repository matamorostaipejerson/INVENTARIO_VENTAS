<?php 
	...
	if (isset($_POST['Registrar'])) { 
		...
		$Sentencia = $conexion->prepare('insert into salidas(Nombre,Hora,Fecha,PrecioTotal) values (?, ?, ?, ?);');
		$arrParams=array($Nombre , $Hora, $Fecha, $PrecioTotal);
				...
				<div class="panel-header bg-info">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Ventas</h2>
													...
													<td align="center">
														<div class="dropdown">
															...
															<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
																<a class="dropdown-item" href="EditarSalida.php?Id_Salida=<?php echo $Array['Id_Salida']?>">Editar</a>
																<a class="dropdown-item" href="EliminarSalida.php?Id_Salida=<?php echo $Array['Id_Salida']?>">Eliminar</a>
															</div>
														</div>
													</td>
												</tr>
