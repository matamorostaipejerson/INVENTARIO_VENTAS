				...
				<div class="panel-header bg-dark2">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Salidas</h2>
						...
						<div class="card">
							<div class="card-header">
								<div class="d-flex align-items-center">
									<h4 class="card-title">Tabla de Salidas</h4>
									<a href="AgregarSalida.php" class="btn btn-primary btn-round ml-auto">
							...
							<div class="card-body">
								<div class="table-responsive">
									<table id="add-row" class="display table table-striped table-hover">
										...
										<tbody>
											<?php
											    $Sentencia2 = $conexion->prepare('SELECT * from salidas');
												$Sentencia2 ->execute(); 
												$resultado1 = $Sentencia2-> fetchAll(PDO::FETCH_ASSOC);
												foreach ($resultado1 as $Array) {?>
											<tr align="center">
												<td><?php echo $Array['Id_Salida'];?></td>
												<td><?php echo $Array['Nombre'];?></td>
												<td><?php echo $Array['Fecha'];?></td>
												<td><?php echo $Array['PrecioTotal'];?></td>
												...
												<td align="center">
													<button class="btn btn-primary BtnDetalles"
														value="<?php echo $Array['Id_Salida'];  ?>">Ver
														Detalles</button>
												</td>
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="exampleModalLabel">Detalles de Salida <span id="Id_Salida"> </span></h5>
												...
												<div class="modal-footer">
													...
													<button type="button" class="btn btn-primary" id="BtnChange">Cambiar Estado</button>
												</div>
											</div>
										</div>
									</div>
