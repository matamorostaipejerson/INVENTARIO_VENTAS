...
<body>
	<div class="wrapper">
		...
		<div class="main-panel">
			<div class="content">
				<div class="panel-header bg-image">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-col">
							<div class="titulo_centrado">
								<h2 class="text-white pb-2 fw-bold">Acerca de kapritecnology</h2>
								<h5 class="text-white op-7 mb-2">Aplicativo web de sistema de inventarios</h5>
							</div>
						</div>
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-col">
							<div class="titulo_centrado">
								<img src="./../assets/img/LogoKapri.png" alt="">
							</div>
						</div>

						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div class=" bg-dark titulo_centrado">
								<div class="container descripcion animated fadeIn">
									<p class="text-danger"><h1>kapritecnology</h1></p>
									<p>Es una empresa especializada en el soporte tecnologico y desarrollo de software, la cual se enfoca
										 en la satisfaccion del cliente. Brindando soluciones tecnologicas basadas en las necesidades del cliente.
