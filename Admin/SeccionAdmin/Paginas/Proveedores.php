				...
				<div class="panel-header bg-dark2">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Proveedores</h2>
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										...
										<a href="AgregarProveedor.php" class="btn btn-primary btn-round ml-auto">
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
											<?php
											    $Sentencia2 = $conexion->prepare('select * from proveedor');
												$Sentencia2 ->execute(); 
												...
												<tr align="center">
													...
													<td><?php echo $Array['PersonaContacto'];?></td>
													...
													<td align="center">
														<div class="dropdown">
															...
															<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
																<a class="dropdown-item" href="EditarProveedor.php?Id_Proveedor=<?php echo $Array['Id_Proveedor']?>">Editar</a>
																<a class="dropdown-item" href="EliminarProveedor.php?Id_Proveedor=<?php echo $Array['Id_Proveedor']?>">Eliminar</a>
															</div>
														</div>
													</td>
												</tr>
