...
switch ($Option) {
    case 1:
        $sentencia = "INSERT INTO salidas(Nombre,Fecha,PrecioTotal) VALUES('$Nombre','$Fecha',$total)";
    ...
    case 2:
        $sentencia = "INSERT INTO detalle_venta(Id_Salida,Id_Articulo,Cantidad,PrecioXunidad,Total ) VALUES($Id,$Id_Articulo,$Cantidad,$PrecioU,$Total)";
        $exe =$con->prepare($sentencia);
        if($exe->execute()){
            $sentencia = "
